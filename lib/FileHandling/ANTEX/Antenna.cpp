...
namespace gpstk
{
       ...
       */
   Antenna::Antenna( const Triple& eccL1, const Triple& eccL2,
                     const Triple& eccL3, const Triple& eccL5,
                     const Triple& eccL6, const Triple& eccL7,
                     const Triple& eccL8, const Triple& eccL9 )
   {
         // Add eccentricities
      addAntennaEcc(G01, eccL1);
      addAntennaEcc(G02, eccL2);
      addAntennaEcc(R01, eccL1);
      addAntennaEcc(R02, eccL2);
      addAntennaEcc(E01, eccL1);
      addAntennaEcc(E05, eccL5);
      addAntennaEcc(E06, eccL6);
      addAntennaEcc(E07, eccL7);
      addAntennaEcc(E08, eccL8);
      addAntennaEcc(C01, eccL1);
      addAntennaEcc(C02, eccL2);
      addAntennaEcc(C06, eccL6);
      addAntennaEcc(C07, eccL7);
      addAntennaEcc(J01, eccL1);
      addAntennaEcc(J02, eccL2);
      addAntennaEcc(J05, eccL5);
      addAntennaEcc(J06, eccL6);
      addAntennaEcc(I05, eccL5);
      addAntennaEcc(I09, eccL9);
