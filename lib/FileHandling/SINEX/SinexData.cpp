      ...
      while (strm.good() )
      {
         ...
         switch (line[0])
         {
            case BLOCK_START:
            {
               ...
               cout << "BLOCK_START break" << endl;
               break;
            }
            case BLOCK_END:
            {
                 cout << "BLOCK_END: " << line << endl;
               if (currentBlock.size() == 0)
               {
            ...
            {
                 cout << "HEAD_TAIL_START: " << line << endl;
