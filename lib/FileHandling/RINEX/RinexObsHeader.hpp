...
//            version = 2.11;
        ...
        static const std::string antennaDeltaHENString; ///< "ANTENNA: DELTA H/E/N"
        static const std::string antennaDeltaXYZString; ///< "ANTENNA: DELTA X/Y/Z"
        static const std::string antennaBSightXYZString;///< "ANTENNA: B.SIGHT XYZ"
        static const std::string obsScaleFactorString;  ///< "OBS SCALE FACTOR"
        static const std::string centerOfMassXYZString; ///< "CNETER OF MASS: XYZ"
        ...
        enum validBits
        {
            ...
            antennaDeltaHENValid    = 0x0200,       ///< "ANTENNA: DELTA H/E/N"
            ...
            antennaDeltaXYZValid    = 0x02000000,   ///< "ANTENNA: DELTA X/Y/Z"
            antennaBSightXYZValid   = 0x04000000,   ///< "ANTENNA: B.SIGHT XYZ"
        ...
        static const RinexObsType LA;
        static const RinexObsType DA;
        static const RinexObsType SA;
        static const RinexObsType CH;
    ...
    inline bool operator==(const RinexObsType& x, const RinexObsType& y)
