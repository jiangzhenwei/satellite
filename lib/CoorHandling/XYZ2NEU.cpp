...
namespace gpstk
{
    ...
    void XYZ2NEU::init()
    {
        ...
        inputSet.clear();
        inputSet.insert(TypeID::dStaX);
        inputSet.insert(TypeID::dStaY);
        inputSet.insert(TypeID::dStaZ);

        outputSet.clear();
        outputSet.insert(TypeID::dStaLat);
        outputSet.insert(TypeID::dStaLon);
        outputSet.insert(TypeID::dStaH);
