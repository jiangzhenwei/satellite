...
namespace gpstk
{
   ...
   public:
      ...
      {};
         ...
         /** Return a satTypeValueMap object, filtering the target
          *  observables.
          *
      ...
      virtual satTypeValueMap& Process(satTypeValueMap& gData)
         ...
         /** Return a gnssSatTypeValue object, filtering the target
          *  observables.
          *
          * @param gData    Data object holding the data.
          */
      ...
      { Process(gData.body); return gData; };
         ...
         /** Return a gnssRinex object, filtering the target observables.
          *
          * @param gData    Data object holding the data.
          */
