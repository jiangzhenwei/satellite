...
//
//  2017-11-14   Change the time system from GPST to UTC by XY. CAO
//============================================================================
...
namespace gpstk
{
    ...
    public:
          ...
          */
        OceanLoading()
            : pBLQStore(NULL), pRefSys(NULL)
        {};


        OceanLoading& setBLQDataReader(BLQDataReader& blqStore)
        { pBLQStore = &blqStore; return (*this); };


        OceanLoading& setReferenceSystem(ReferenceSystem& refSys)
        { pRefSys = &refSys; return (*this); };
          ...
          */
        Triple getOceanLoading( const CommonTime& time,
