...
//            cout << "debug" << endl;
            ...
            if ( insideUnstable && deleteUnstableSats )
            {
               satRejectedSet.insert( (*it).first );
            }
...
//         cout << satRejectedSet.size() << endl;
      ...
      /* Return a gnnsSatTypeValue object, adding the new data generated
       *  when calling this object.
       *
       * @param gData    Data object holding the data.
       */
      ...
      throw(ProcessingException)
   {
      ...
      /* Return a gnnsRinex object, adding the new data generated when
       *  calling this object.
       *
       * @param gData    Data object holding the data.
       */
