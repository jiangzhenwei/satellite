#pragma ident "$Id XY. CAO 2017-11-13 $"
...
//  Revision
//
//  2014/03/03      Change the timeSystem from 'GPS' to 'UTC', which will
//                  be used in 'EOPDataStore'. (shjzhang)
//
//  2017/011/13      IERS2003-> IERS2010( XY. CAO, Wuhan University)
//============================================================================
