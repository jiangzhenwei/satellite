...
namespace gpstk
{
   ...
   public:
      ...
      { return gData; }
         ...
         /// Return pointer to stream object used for output.
      ...
      { outStr = &out; return (*this); };
         ...
         /// Return flag controlling TypeID printing.
      ...
      { printType = printtype; return (*this); };
         ...
         /// Return flag controlling CommonTime printing.
      ...
      { printTime = printtime; return (*this); };
         ...
         /// Return flag controlling SourceID printing.
