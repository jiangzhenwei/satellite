...
namespace gpstk
{
    ...
    equationHeader& equationHeader::operator=(const equationHeader& right)
    {
        ...
        equationEpoch = right.equationEpoch;
    ...
    Equation::Equation()
    {
        ...
        header.equationEpoch = CommonTime::BEGINNING_OF_TIME;
...
//            Variable var(*pos);
//
//            // Force coefficient default or not?
//            //@author shjzhang
//            // always = false
//            bool forceDefault(var.isDefaultForced());
//
//            // Get the default coefficient
//            //@author shjzhang
//            // always = 1.0
//            double defaultCoefficient(var.getDefaultCoefficient());
//
//            // Coefficient object
//            //@author shjzhang
//            Coefficient  coef(forceDefault, defaultCoefficient);
//
