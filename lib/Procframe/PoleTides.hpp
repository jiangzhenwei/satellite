...
namespace gpstk
{
    ...
    public:
        ...
        PoleTides()
            : xdisp(0.0), ydisp(0.0), pRefSys(NULL)
        {};
        ...
        PoleTides( const double& x,
                   const double& y )
            : xdisp(x), ydisp(y), pRefSys(NULL)
        {};


         /** Common constructor
          *
          * @param refSys     ReferenceSystem
          */
        PoleTides( ReferenceSystem& refSys )
            : pRefSys(&refSys)
        {};


        PoleTides& setReferenceSystem(ReferenceSystem& refSys)
        ...
        Triple getPoleTide( const CommonTime& t,
         ...
         /** Return the effect of pole tides (meters) on the given
