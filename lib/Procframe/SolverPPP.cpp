...
covariance matrix.");
        ...
        throw(ProcessingException)
    {
        ...
        try
        {
            ...
            Vector<double> prefitL(gData.getVectorOfTypeID(TypeID::prefitL12ForPPP));
            ...
            satTypeValueMap dummy(gData.body.extractTypeID(TypeID::weightC));
            ...
            if ( dummy.numSats() == (size_t)numCurrentSV )
            {
                ...
                Vector<double>
                weightsVector(gData.getVectorOfTypeID(TypeID::weightC));
    ...
    SolverPPP& SolverPPP::setNEU( bool useNEU )
    {
        ...
        if (useNEU)
        {
            tempSet.insert(TypeID::dStaLat); // #2
            tempSet.insert(TypeID::dStaLon); // #3
            tempSet.insert(TypeID::dStaH);   // #4
        }
        else
        {
            tempSet.insert(TypeID::dStaX);   // #2
            tempSet.insert(TypeID::dStaY);   // #3
            tempSet.insert(TypeID::dStaZ);   // #4
        }
        tempSet.insert(TypeID::dcdtSta);     // #5
